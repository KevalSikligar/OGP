...
namespace OGP_Portal.Service.Schedule_Services
{
    ...
    {
        string conSting = "Server=SUN;Database=OGP_DB;Trusted_Connection=False;MultipleActiveResultSets=true;User Id=OGP_User;Password=OGPPASSword123#;Connection Timeout=1000;";
