...
namespace OGP_Portal.Service.BackGroundService
{
    public class SchedulerEmailService
    {
        ...
        public string ReadEmailTemplate(string currentPath, string templateName, string physicalUrl)
        {
            try
            {
                ...
                currentPath = Path.Combine(Directory.GetCurrentDirectory() +"\\"+ currentPath, templateName);
               // currentPath = Directory.GetCurrentDirectory() + "EmailTemplate\\" + templateName;
